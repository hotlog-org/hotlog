      ...
      <div className='min-h-screen relative bg-[radial-gradient(80%_60%_at_100%_0%,hsl(var(--foreground)/0.06)_0%,transparent_60%),radial-gradient(60%_50%_at_0%_100%,hsl(var(--foreground)/0.05)_0%,transparent_60%)]'>
        ...
        <div className='relative mx-auto max-w-5xl px-6 pt-28 pb-16 sm:pt-36'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <p className='mt-5 text-base md:text-lg text-muted-foreground max-w-2xl mx-auto'>
              A centralized platform to track performance, visualize usage,
              manage versions, and keep production systems stable. Understand
              latency, availability, errors, traffic patterns, and client
          ...
          <div className='mt-14 grid grid-cols-2 sm:grid-cols-3 gap-5 max-w-4xl mx-auto'>
            {(() => {
              const ts: TimeSeriesData[] = Array.from({ length: 12 }).map(
                (_, i) => ({
              ...
              const hm: HeatmapData[] = Array.from({ length: 7 * 6 }).map(
                (_, idx) => ({
          ...
          <div className='grid gap-6 md:grid-cols-3'>
            <Card className='border border-border/60 bg-background/70 backdrop-blur-sm hover:shadow-md hover:ring-1 hover:ring-foreground/10 transition-all'>
              ...
              <CardContent className='text-sm text-muted-foreground'>
                Track latency, throughput, and status codes from the services
                you depend on.
              </CardContent>
            </Card>
            <Card className='border border-border/60 bg-background/70 backdrop-blur-sm hover:shadow-md hover:ring-1 hover:ring-foreground/10 transition-all'>
              ...
              <CardContent className='text-sm text-muted-foreground'>
                See requests by day with clean graphs that make patterns obvious
                at a glance.
              </CardContent>
            </Card>
            <Card className='border border-border/60 bg-background/70 backdrop-blur-sm hover:shadow-md hover:ring-1 hover:ring-foreground/10 transition-all'>
              ...
              <CardContent className='text-sm text-muted-foreground'>
                Identify failing endpoints and error spikes before they impact
                your customers.
              </CardContent>
            </Card>
          </div>
        ...
        <div className='relative mx-auto max-w-5xl px-6 pb-16'>
          <div className='grid gap-6 md:grid-cols-2'>
            <Card className='border border-border/60 bg-background/70 backdrop-blur-sm hover:shadow-md hover:ring-1 hover:ring-foreground/10 transition-all'>
              <CardHeader className='pb-3'>
                <h3 className='text-lg font-medium'>Built for observability</h3>
              </CardHeader>
              <CardContent className='text-sm text-muted-foreground'>
                Track latency and uptime in real time, compare versions across
                releases, and see how clients interact with each endpoint.
                Configure alerts for high latency, error spikes, or availability
                drops.
              </CardContent>
            </Card>
            <Card className='border border-border/60 bg-background/70 backdrop-blur-sm hover:shadow-md hover:ring-1 hover:ring-foreground/10 transition-all'>
              <CardHeader className='pb-3'>
                <h3 className='text-lg font-medium'>Version lifecycle</h3>
              </CardHeader>
              <CardContent className='text-sm text-muted-foreground'>
                Release new versions with confidence, deprecate old ones
                gradually, and guide users with migration insights.
                Automatically detect breaking changes and maintain a stable API
                over time.
              </CardContent>
            </Card>
          </div>
        ...
        <div className='relative mx-auto max-w-5xl px-6 pb-20'>
          <div className='rounded-xl border border-border/60 bg-[linear-gradient(to_right,hsl(var(--foreground)/0.035),transparent),linear-gradient(to_left,hsl(var(--foreground)/0.035),transparent)] p-6 md:p-8 text-center'>
            <h2 className='text-2xl md:text-3xl font-semibold tracking-tight'>
              Start observing what matters
            </h2>
            <p className='mt-2 text-sm md:text-base text-muted-foreground'>
              See requests, spot errors, and ship fixes faster with confidence.
            </p>
