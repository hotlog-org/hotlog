...
export default async function Page() {
  ...
  const translations = {
    ...
    'features.realTimeMonitoring.title': service.t('features.realTimeMonitoring.title'),
    'features.realTimeMonitoring.description': service.t('features.realTimeMonitoring.description'),
    'features.advancedAnalytics.title': service.t('features.advancedAnalytics.title'),
    'features.advancedAnalytics.description': service.t('features.advancedAnalytics.description'),
    'features.visualDashboards.title': service.t('features.visualDashboards.title'),
    'features.visualDashboards.description': service.t('features.visualDashboards.description'),
    'features.easyIntegration.title': service.t('features.easyIntegration.title'),
    'features.easyIntegration.description': service.t('features.easyIntegration.description'),
