...
const shuffleStyles = `
.shuffle-parent{display:inline-block;white-space:normal;word-wrap:break-word;will-change:transform;line-height:1;visibility:hidden}
.shuffle-parent.is-ready{visibility:visible}
.shuffle-char{line-height:1;display:inline-block;text-align:center}
`
  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        chars.forEach((_ch: Element) => {
          const ch = _ch as HTMLElement
      ...
      const inners = () =>
        wrappersRef.current.map((w) => w.firstElementChild!)
